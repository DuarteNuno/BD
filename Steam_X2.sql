...
VALUES
/*1*/(7,'GTA V','2016-11-23 00:01:23','Jogo muito cansativo',1),/*GTA V*/
/*2*/(4,'Counter-Strike 1.6','2006-06-30 12:01:07','I love Lara Croft',5),/*CS 1.6*/
/*3*/(1,'The Elder Scrols V: Skyrim','2019-11-04 11:53:27',NULL,3),/*Skyrim*/
/*4*/(3,'Tomb Raider(2013)','2013-07-22 11:47:12','J\'aime Lara Croft',5),/*TOMB RAIDER*/
/*5*/(10,'ARK: Survival Evolved','2018-04-05 17:21:14','Bad FPS and optimization',1),/*ARK*/
/*6*/(5,'Witcher 3','2015-06-11 22:12:54','Amazing story and characters but my pc can\'t handle well its graphics',4),/*WITCHER3*/
/*7*/(2,'The Elder Scrols V: Skyrim','2011-03-25 23:17:36',NULL,5),/*Skyrim*/
